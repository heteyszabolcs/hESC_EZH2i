...
suppressPackageStartupMessages({
  ...
  library("glue")
  library("data.table")
  library("cicero", lib = "/proj/snic2020-6-3/SZABOLCS/hESC_EZH2i/utils/cicero_monocle3/")
  library("Seurat")
})
...
cicero_analysis = function(seurat_object_path,
                           ...
                           chroms = "../data/hg38.chrom.sizes.txt",
                           nfeature = 50000) {
...
cicero_analysis(seurat_object_path="../results/scATAC-Seq/hESC_scATAC_7d_EZH2i_Seurat.Rds", label="trt")